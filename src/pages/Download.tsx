...
export function Download() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[var(--paper)] px-6 text-center">
      ...
      <h1 className="mt-8 font-display text-3xl font-semibold text-[var(--ink)]">PrestApp siempre contigo</h1>
      ...
      {installed ? (
        ...
        <p className="mt-8 text-sm text-[var(--muted)]">
          Desde el menú de tu navegador, elige "Agregar a pantalla de inicio" para instalar PrestApp.
        </p>
      )}
    </div>
  );
